...
export const SettingsOptionModal = ({ modalData, onClose }: SettingsOptionModalProps) => {
  ...
  return (
    <Modal transparent animationType="fade" visible={!!modalData} onRequestClose={onClose}>
